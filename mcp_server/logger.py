...
def get_default_logger() -> logging.Logger:
    ...
    if _default_logger is None:
        ...
        enable_file = os.getenv("MCP_SERVER_ENABLE_FILE_LOG", "true").lower() == "true"
        enable_console = os.getenv("MCP_SERVER_ENABLE_CONSOLE_LOG", "true").lower() == "true"
        log_dir = os.getenv("MCP_SERVER_LOG_DIR")
